...
class RAGStore:
    ...
    def __init__(
        ...
        self.supabase_url = supabase_url or os.environ.get("https://gkqurtauzhnjeqxxpoil.supabase.co")
        self.supabase_key = supabase_key or os.environ.get("sb_publishable_DsYC8Yc2POwUwL3Md7-gjw_v2yx6OK5")
        self.database_url = database_url or os.environ.get("supabase link --project-ref gkqurtauzhnjeqxxpoil")
